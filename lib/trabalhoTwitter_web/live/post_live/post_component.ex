defmodule TrabalhoTwitterWeb.PostLive.PostComponent do
  use TrabalhoTwitterWeb, :live_component
        ...
        <div class="row actions_bar">
          <div class="column column-33 text-center">
            <a href="#" phx-click="like" phx-target="<%= @myself %>">
              <span>(👍🏻ﾟヮﾟ)👍🏿 </span> <%= @post.likes_count %>
            </a>
          </div>
          <div class="column column-33 text-center">
  ...
  def handle_event("like", _, socket) do
    TrabalhoTwitter.Timeline.inc_likes(socket.assigns.post)
    {:noreply, socket}
  end

  def handle_event("repost", _, socket) do
    TrabalhoTwitter.Timeline.inc_reposts(socket.assigns.post)
    {:noreply, socket}
  end
end
