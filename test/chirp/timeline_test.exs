defmodule Chirp.TimelineTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", likes_count: 42, reposts_count: 42, username: "some username", visible: 42}
    @update_attrs %{body: "some updated body", likes_count: 43, reposts_count: 43, username: "some updated username", visible: 43}
    @invalid_attrs %{body: nil, likes_count: nil, reposts_count: nil, username: nil, visible: nil}
